  ...
  extensions: Extension[] = [
    {
      ...
      tenantId: 'tenant-enlace-matriz',
      number: '4101',
      name: 'Recepção / Atendimento Matriz',
      sipSecret: 'Enlace@4101#Sec',
      context: 'from-internal',
      callerId: '"Recepção SP" <4101>',
    ...
    },
    {
      ...
      tenantId: 'tenant-enlace-matriz',
      number: '4102',
      name: 'Suporte Técnico N1 (Mariana)',
      sipSecret: 'Enlace@4102#Sec',
      context: 'from-internal',
      callerId: '"Mariana Duarte" <4102>',
    ...
    },
    {
      ...
      tenantId: 'tenant-enlace-matriz',
      number: '4103',
      name: 'Comercial Enlace (Lucas)',
      sipSecret: 'Enlace@4103#Sec',
      context: 'from-internal',
      callerId: '"Lucas Barreto" <4103>',
  ...
  ivrs: Ivr[] = [
    {
      ...
      number: '6001',
      audioPrompt: 'Olá! Você ligou para a Enlace Telecom. Para Comercial digite 1. Para Suporte Técnico digite 2. Para Financeiro digite 3. Ou digite 9 para falar com nossa atendente de Inteligência Artificial MaIA.',
      timeoutSeconds: 10,
      invalidRetries: 3,
      options: [
        { digit: '1', label: 'Comercial', destinationType: 'extension', destinationTarget: '4103' },
        { digit: '2', label: 'Suporte Técnico', destinationType: 'queue', destinationTarget: 'queue-suporte-n1' },
        { digit: '3', label: 'Financeiro', destinationType: 'queue', destinationTarget: 'queue-financeiro' },
        { digit: '9', label: 'Falar com Agente IA MaIA', destinationType: 'ai_agent', destinationTarget: 'agent-maia-247' },
        { digit: '0', label: 'Operador Humano', destinationType: 'extension', destinationTarget: '4101' },
      ],
    },
  ];
