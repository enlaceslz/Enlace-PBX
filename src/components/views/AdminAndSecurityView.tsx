                ...
                <tbody className="divide-y divide-slate-100 font-sans">
                  {auditLogs.map((log) => (
                    <tr key={log.id} className="hover:bg-slate-50 transition">
                      ...
                      <td className="py-3.5 px-4">
                        <span className="font-mono text-[10px] uppercase font-bold bg-slate-100 px-2 py-0.5 rounded text-slate-700">
                          {log.action}
                        </span>
                      </td>
            ...
            {health?.components &&
              Object.entries(health.components).map(([key, val]: [string, any]) => (
                ...
                >
                  ...
                  <div className="pt-2 border-t border-slate-200 text-xs font-mono text-slate-500 space-y-1">
