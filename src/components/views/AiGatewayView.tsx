              ...
              >
                ...
                <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between text-xs font-mono text-slate-400">
                  ...
                  <button
                    ...
                    className="text-sky-400 font-sans font-bold hover:underline"
                  >
                    Testar Voz →
                  </button>
                </div>
            ...
            <div className="lg:col-span-2 bg-slate-900/80 rounded-2xl border border-slate-800/80 p-6 space-y-5">
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold rounded-xl text-xs flex items-center gap-2 transition"
                >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                ...
                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
                  ...
                  <span className="text-sky-400 font-bold">Habilitado</span>
                </div>
                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800">
              ...
              <div className="bg-slate-950 p-3 rounded-xl border border-slate-800 space-y-2 text-xs font-mono">
                <div className="flex items-center justify-between text-slate-400">
                  <span className="flex items-center gap-1">
                    <Lock className="w-3 h-3 text-sky-400" /> API Key Protegida:
                  </span>
            ...
            {selectedTool ? (
              <div className="space-y-4 text-xs">
                ...
                <div>
                  ...
                  <pre className="bg-slate-950 p-3 rounded-xl border border-slate-800 text-[11px] font-mono text-sky-300 max-h-48 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {knowledge.map((k) => (
            ...
            >
              ...
              <div className="pt-3 border-t border-slate-800 flex items-center justify-between text-[11px] text-sky-400">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-800 pb-3">
                ...
                <div className="flex items-center gap-2 text-xs font-mono">
                  ...
                  <span className="px-2.5 py-1 rounded bg-sky-950 text-sky-300 border border-sky-800">
